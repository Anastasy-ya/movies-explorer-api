...
// const { isEmail } = require('validator'); // , isStrongPassword
...
const userSchema = new mongoose.Schema({
  name: {
    ...
    required: true,
    unique: true,
    minlength: 2, // по идее это не нужно поскольку валидация происходит на уровне модуля
    maxlength: 30,
  ...
  password: {
    type: String,
    select: false, // не отправлять пользователю
    required: true,
